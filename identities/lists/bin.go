...
var ccBanks = []string{"AGOS DUCATO S.P.A.",
	"AGOS S.P.A.",
	"AMERICAN EXPRESS",
	"B@NCA 24-7 S.P.A.",
	...
	"BANCA POPOLARE DELLEMILIA ROMAGNA S.C.R.L.",
	...
	"CARTASI S.P.A.",
	"CASSA CENTRALE BANCA - CREDITO COOPERATIVO DEL NORD E",
	...
	"ICCREA BANCA S.P.A",
	"ICCREA BANCA S.P.A. - ISTITUTO CENTRALE DEL CREDITO COOPERAT",
	"ING DIRECT, N.V.",
	"INTEGRA S.P.A.",
	"INTESA SAN PAOLO",
	"INTESA SANPAOLO",
	...
	"ISTITUTO DI MONETA ELETTRONICA EUROPEO S.P.A.",
	"IW BANK S.P.A.",
	"IWBANK S.P.A.",
	"KEY CLIENT CARDS AND SOLUTIONS S.P.A.",
	"LINEA S.P.A.",
	...
	"ONEY S.P.A.",
	"POSTE ITALIANE",
	"POSTE ITALIANE S.P.A. (BANCO POSTA)",
	"RIMINI BANK",
	"SANPAOLO IMI S.P.A.",
	...
	"SETEFI S.P.A.",
	"SOCIETA PER I SERVIZI BANCARI S.P.A. (SSB)",
